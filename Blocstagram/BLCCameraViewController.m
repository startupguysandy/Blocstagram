...
- (void) rightButtonPressedOnToolbar:(BLCCameraToolbar *)toolbar {
    BLCImageLibraryViewController *imageLivraryVC = [[BLCImageLibraryViewController alloc] init];
    imageLivraryVC.delegate = self;
    [self.navigationController pushViewController:imageLivraryVC animated:YES];
}

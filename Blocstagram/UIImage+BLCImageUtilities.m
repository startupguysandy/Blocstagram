...
- (UIImage *) imageWithFixedOrientation {
    ...
    // We need to calculate the proper transformation to maek the image upright.
    // We do it in 2 steps: Rotate if Left/Right/Down, and then flip is Mirrored.
...
- (UIImage *) imageResizedToMatchAspectRatioOfSize:(CGSize)size {
    ...
    // Get the resized image from the contect and a UIImage

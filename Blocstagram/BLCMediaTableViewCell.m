...
- (void) layoutSubviews {
    ...
    // And add 20 to the height for some bertical padding
    ...
    if (_mediaItem.image) {
        self.imageHeightConstraint.constant = self.mediaItem.image.size.height / self.mediaImageView.image.size.width * CGRectGetWidth(self.contentView.bounds);
    } else {
